...
#endif
{
	...
	printk ("mod is %i nad %i\n", dirdata.mode, i->i_mode);
	dirdata.mode = i->i_mode;
	printk ("2 - mod is %i nad %i\n", dirdata.mode, i->i_mode);
